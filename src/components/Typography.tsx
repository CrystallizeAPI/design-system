...
const complexMixin = css<TypographyWrapperProps>`
  margin: 0;
...
const StyledH1 = styled.h1<TypographyWrapperProps>`
  ${complexMixin};
`;

const H1 = React.forwardRef<HTMLHeadingElement, TypographyWrapperProps>(
  (props, ref) => {
    return (
